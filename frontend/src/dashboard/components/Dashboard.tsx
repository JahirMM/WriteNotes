  ...
  return (
    <div className="h-screen w-full p-2">
      <div className="bg-backgroundDashboard rounded-2xl overflow-auto scrollHidden h-full w-full p-4 grid grid-cols-1 gap-4 md:grid-cols-5">
        ...
        />
        <section className="bg-backgroundNotes rounded-xl p-3 flex flex-col justify-evenly gap-4 md:gap-0 md:col-span-5">
        ...
        <section className="bg-backgroundNotes rounded-xl p-3 flex flex-col justify-evenly gap-4 row-start-4 row-end-5 md:row-start-3 md:gap-0 md:row-end-4 md:col-span-3">
